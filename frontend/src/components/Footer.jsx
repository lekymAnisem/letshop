    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">LetShop</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-sm hover:text-white">All Products</Link></li>
              <li><Link to="/?category=Electronics" className="text-sm hover:text-white">Electronics</Link></li>
              <li><Link to="/?category=Fashion" className="text-sm hover:text-white">Fashion</Link></li>
              <li><Link to="/?category=Home" className="text-sm hover:text-white">Home & Living</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} LetShop. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
